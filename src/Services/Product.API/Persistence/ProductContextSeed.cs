    ...
    private static IEnumerable<CatalogProduct> getCatalogProducts()
    {
        return new List<CatalogProduct>
        {
            new()
            {
                ...
                Price = 12.99m,
                ImageUrl = "https://images.unsplash.com/photo-1552539618-7eec9b4d1796?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fFBpenphJTIwTWFyZ2hlcml0YXxlbnwwfHwwfHx8MA%3D%3D"
            },
            new()
            {
                No = "ChickenParmesan",
